...
from dyna_route.datasets.ts_dataset import TimeSeriesDataset


class DynaRouteWindowDataset:
    """
    ...
    Example:
        ...
        >>> context_length = 10
        >>> prediction_length = 5
        >>> window_dataset = DynaRouteWindowDataset(dataset, context_length, prediction_length)
...
class UniversalDynaRouteWindowDataset:
    """
